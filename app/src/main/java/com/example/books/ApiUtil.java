...
public class ApiUtil {
    ...
    public static final String API_KEY ="AIzaSyATKS8MtpKC4Qiww70v7tOcRk_d_e_5rqk";
...
//                .build();
    ...
    public  static String getJson(URL url) throws IOException {
        ...
        //hasNext return true if has dat or false if not
        try {

            //reading data
            InputStream stream = connection.getInputStream();
            //reading json via scanner
    ...
    public static ArrayList<Book> getBooksFromJson(String json) {
        ...
        final  String PUBLISHED_DATE = "buplishedDate";
        ...
        try{
            ...
            for (int i =0; i<numberOfBooks;i++){
                ...
                //book may not  have image
                JSONObject imageLinksJSON = null;
                //if books doesnt image use provide book cover
